(function() {
  var CPFRandomizerDynamicValue;

  CPFRandomizerDynamicValue = function() {
	...
	CPFRandomizerDynamicValue.identifier = "br.com.concretesolutions.PawExtension.CPFRandomizerDynamicValue";

  CPFRandomizerDynamicValue.title = "CPF Randomizer Dynamic Value";

  CPFRandomizerDynamicValue.inputs = [
  DynamicValueInput("format", "Formatted", "String")
  ];

  registerDynamicValueClass(CPFRandomizerDynamicValue);
